...
##' al.\sspace{}(2017) and maintained in KantorovÃ¡ et
...
##'
##' This expression is due to N. Cahill (pers. comm.); see Cahill et al.\sspace{} (2017) and Dasgupta et al.\sspace{}(2022), Appendix A, Sect. 1.4.1.}
##'
##' @references
##'
