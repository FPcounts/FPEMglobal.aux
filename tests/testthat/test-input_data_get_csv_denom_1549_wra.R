...
test_that("get_used_csv_denominators works with default argument values on a 15-49, all women directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/15-49_all_women", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
...
test_that("get_used_csv_denominators works with specified arguments on a 15-49, all women directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/15-49_all_women", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
