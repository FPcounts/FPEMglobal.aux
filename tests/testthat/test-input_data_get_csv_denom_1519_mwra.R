...
test_that("'get_used_csv_denominators_filepath' works with default argument values on a 15-19, married directory", {
    ## Output directory
    test_output_dir <-
...
test_that("get_denominators(..., version = \"used_csv\") works with default argument values on a 15-19, married directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/15-19_married", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
...
test_that("get_denominators(..., version = \"used_csv\") works with specified arguments on a 15-19, married directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/15-19_married", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
