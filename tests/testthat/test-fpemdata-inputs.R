...
test_that("country_classifications_2_fpemdata works", {
    ...
    test_output_dir <-
        system.file("data-test/15-49_married", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
    expect_s3_class(country_classifications_2_fpemdata(test_output_dir), "tbl_df")
...
test_that("input_data_2_fpemdata works", {
    ...
    test_output_dir <-
        system.file("data-test/15-49_married", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
    expect_s3_class(input_data_2_fpemdata(test_output_dir), "tbl_df")

    ## All women
    test_output_dir <-
        system.file("data-test/15-49_all_women", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
    expect_error(input_data_2_fpemdata(test_output_dir))
...
test_that("denominators_2_fpemdata works", {
    ...
    test_output_dir <-
        system.file("data-test/15-49_married", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
    expect_s3_class(denominators_2_fpemdata(test_output_dir), "tbl_df")
