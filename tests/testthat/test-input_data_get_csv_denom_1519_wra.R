...
test_that("get_csv_denominators works with default argument values on a 15-19, all women directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/test_output_15-19_all_women", package = "FPEMglobal.aux")
...
test_that("get_csv_denominators works with specified arguments on a 15-19, all women directory", {
    ## Output directory
    test_output_dir <-
        system.file("data-test/test_output_15-19_all_women", package = "FPEMglobal.aux")
    expect_true(dir.exists(test_output_dir))
